#!/usr/bin/env python
"""
Script pour supprimer toutes les signatures enregistrées existantes.
...
if __name__ == '__main__':
    confirm = input("Êtes-vous sûr de vouloir supprimer toutes les signatures enregistrées ? (oui/non): ")
